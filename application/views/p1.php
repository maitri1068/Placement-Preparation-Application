...
<!-- 
        ...
        <div class="row">
            <div class="col">
                <div class="company-logo m-3">
                    <img src="http://127.0.0.1/ci4/assets/tcs.png" alt="" >
                </div>
            </div>
            <div class="col">
            <div class="company-logo m-3">
                    <img src="http://127.0.0.1/ci4/assets/infostretch.png" alt="" style="width:200px">
                </div>
            </div>
            <div class="col">
            <div class="company-logo mt-4 pt-4">
                    <img src="http://127.0.0.1/ci4/assets/juspay.png" alt=""  style="width:250px;height: 50px">
                </div>
            </div>
            <div class="col">
            <div class="company-logo m-3">
                    <img src="http://127.0.0.1/ci4/assets/Crest-Logo.png" alt="" style="width:200px;height: 90px">
                </div>
            </div>
        </div>
        <div class="row ">
            <div class="col">
                <div class="company-logo m-4">
                    <img src="http://127.0.0.1/ci4/assets/torrent_power.png" class="float-end "alt="" style="width:200px;height: 50px">
                </div>
            </div>
            <!-- <div class="col">
            ...
            <div class="col">
            <div class="company-logo m-4">
                    <img src="http://127.0.0.1/ci4/assets/L&T.png" alt="" style="width:130px" >
                </div>
            </div>
            <div class="col">
            <div class="company-logo m-4">
                    <img src="http://127.0.0.1/ci4/assets/capgemini.png" class="float-start" alt="" style="width:200px;height: 50px">
                </div>
            </div>
        </div>
  ...
  <!-- <script src="http://127.0.0.1/ci4/assets/skrollr.js"></script>
